...
需要修改raw_dir和repo_id和root和taskname。其中root的lerotest6这层级文件夹不能提前存在。
    ...
    for hdf5_path in hdf5_paths:
        with h5py.File(hdf5_path, "r") as data:
            ...
            if compressed_images:
                ...
                compressed_image_data = data[f"/observations/images/{camera_keys[0]}"][0]  # 获取第一帧
                ...
                # cv2.waitKey(0)
                # 存储解码图像的shape
                cam_shape.append(decoded_image.shape)
